    ...
    <script>
        $(function(){
            $("#myfile").on("change",function(e){
                ...
                if(file)
                {
                    $("#imageview img").attr('src', URL.createObjectURL(file));
                    $("#imageview").show();
                }
            });
        });
