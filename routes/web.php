...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/account-order',[UserController::class, 'orders'])->name('user.order');
...
Route::middleware(['auth', AuthAdmin::class])->group(function(){
    ...
    Route::put('/admin/order/update-status',[AdminController::class, 'order_update_status'])->name('admin.order.status.update');
